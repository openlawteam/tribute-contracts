...
export const contracts: Array<ContractConfig> = [
  ...
  },
  {
    ...
    name: "DaoV1Factory",
    alias: "daoV1Factory",
    path: "../../contracts/core/DaoV1Factory",
    enabled: true,
    skipAutoDeploy: true,
    version: "1.0.0",
    type: ContractType.Factory,
    ...
    generatesExtensionId: "dao-registry-v1",
  },
  {
    id: "dao-registry",
    name: "DaoRegistry",
  ...
  },
  {
    id: "dao-registry-v1",
    name: "DaoRegistryV1",
    path: "../../contracts/core/DaoRegistryV1",
    enabled: true,
    version: "1.0.0",
    type: ContractType.Core,
    acls: {
  ...
  },
  {
    ...
    name: "BankV1UpgradeFactory",
    alias: "bankV1UpgradeExtFactory",
    path: "../../contracts/extensions/bank/BankV1UpgradeFactory",
    enabled: true,
    skipAutoDeploy: true,
    version: "1.0.0",
    type: ContractType.Factory,
